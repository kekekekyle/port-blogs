...
describe('most blogs', () => {
  ...
  test('when the list has no blogs, should return null author with 0 blogs', () => {
  ...
  test('when list has many blogs, return the author with the most likes, and the number of blogs by that author', () => {
